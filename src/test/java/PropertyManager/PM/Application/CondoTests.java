...
public class CondoTests {
    ...
    public void testGetCondo() throws IOException {
       ...
       CondoTO condo = objectMapper.readValue(response.body().string(), CondoTO.class);
...
//System.out.print("#########11"+response.body().string());
        ...
        if(addressRS.next()){
            ...
            Assert.fail("NO RESULT SET FOUND FOR PROPERTY MATCHING ID: 7ab012b6-8845-4bd4-abfa-50cafa68b8e2!");
        }
    }
